          ...
          <div className="flex flex-wrap gap-2 mt-3">
            {house.property_type === "whole_house" ? (
              <>
                ...
                {isWholeHouseVacant ? (
                  <span className="px-2.5 py-1 rounded-full bg-emerald-600 text-white text-xs font-semibold animate-pulse">
                    🟢 Còn trống
                  </span>
                ) : (
                  <span className="px-2.5 py-1 rounded-full bg-stone-200 text-stone-700 text-xs font-medium">
                    🔒 Đã thuê
                  </span>
                )}
              </>
